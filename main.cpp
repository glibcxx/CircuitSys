...
int main(int, char **)
{
    ...
    ProducerComponent    *producer = circuitSystem.create<ProducerComponent>({0, 0, 0}, &region, Facing::DOWN);
    TransporterComponent *rsWire = circuitSystem.create<TransporterComponent>({1, 0, 0}, &region, Facing::DOWN);
    TransporterComponent *rsWire2 = circuitSystem.create<TransporterComponent>({2, 0, 0}, &region, Facing::DOWN);
    RepeaterCapacitor    *repeater = circuitSystem.create<RepeaterCapacitor>({3, 0, 0}, &region, Facing::WEST);
